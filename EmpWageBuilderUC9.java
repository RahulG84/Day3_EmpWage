...
public class EmpWageBuilderUC9 {
    ...
    public EmpWageBuilderUC9(String company, int emp_Wage_Per_Hr, int max_Working_Days, int maxHr_In_Month) {
    ...
    public static void main(String[] args) {
        ...
        EmpWageBuilderUC9 reliance = new EmpWageBuilderUC9("Reliance", 25, 40, 150);
